...
import (
	...
	internalinterfaces "database-controller/pkg/generated/informers/externalversions/internalinterfaces"
	v1 "database-controller/pkg/generated/listers/ranchercontroller/v1"
	time "time"
...
// one. This reduces memory Databasetprint and number of connections to the server.
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.RanchercontrollerV1().Databases(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.RanchercontrollerV1().Databases(namespace).Watch(options)
			},
		},
		&ranchercontrollerv1.Database{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *databaseInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&ranchercontrollerv1.Database{}, f.defaultInformer)
}
